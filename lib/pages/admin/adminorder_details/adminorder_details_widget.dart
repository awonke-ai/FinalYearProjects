...
import 'adminorder_details_model.dart';
export 'adminorder_details_model.dart';
...
class _AdminorderDetailsWidgetState extends State<AdminorderDetailsWidget> {
  late AdminorderDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminorderDetailsModel());
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    columnOrdersRecord.cutstomerName,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    columnOrdersRecord.customePhone,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
                                  ...
                                  InkWell(
                                    ...
                                    onLongPress: () async {
                                      await Clipboard.setData(ClipboardData(
                                          text: columnOrdersRecord.address));
                                    },
                                    child: Text(
                                      columnOrdersRecord.address
                                          .maybeHandleOverflow(
                                        maxChars: 20,
                                        replacement: '…',
                                      ),
                              ...
                              Builder(
                                builder: (context) {
                                  final orderList =
                                      columnOrdersRecord.itemsOrdered.toList();
