...
class EditItemWidget extends StatefulWidget {
  ...
  final DocumentReference? fooddetails;
        ...
        body: SafeArea(
          ...
          child: Padding(
            ...
            child: StreamBuilder<FoodItemRecord>(
              stream: FoodItemRecord.getDocument(widget.fooddetails!),
              builder: (context, snapshot) {
                ...
                final columnFoodItemRecord = snapshot.data!;
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        controller: _model.textController1 ??=
                          ...
                          text: columnFoodItemRecord.foodName,
                        ),
                            ...
                            child: FlutterFlowDropDown<String>(
                              controller: _model.dropDownValueController ??=
                                ...
                                _model.dropDownValue ??=
                                    columnFoodItemRecord.categoryRef,
                              ),
                              options: const [
                                'Krispy Combos',
                                'Krispy Deals',
                              ...
                              hintText: columnFoodItemRecord.categoryRef,
                              icon: Icon(
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        controller: _model.textController2 ??=
                            TextEditingController(
                          text: columnFoodItemRecord.price.toString(),
                        ),
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        controller: _model.textController4 ??=
                            TextEditingController(
                          text: columnFoodItemRecord.description,
                        ),
