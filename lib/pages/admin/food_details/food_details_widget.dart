...
import '/pages/popups/confirm_delete/confirm_delete_widget.dart';
...
class _FoodDetailsWidgetState extends State<FoodDetailsWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<FoodItemRecord>(
      stream: FoodItemRecord.getDocument(widget.foodRef!),
      builder: (context, snapshot) {
        ...
        final foodDetailsFoodItemRecord = snapshot.data!;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0.0, 20.0, 10.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        ...
                        children: [
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: Image.network(
                                    foodDetailsFoodItemRecord.foodImg,
                                  ).image,
                                ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  foodDetailsFoodItemRecord.foodName,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Inter',
                                ...
                                Expanded(
                                  child: Align(
                                    ...
                                    child: Text(
                                      formatNumber(
                                        foodDetailsFoodItemRecord.price,
                              ...
                              child: Align(
                                ...
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      10.0, 0.0, 10.0, 0.0),
                                  child: Text(
                                    foodDetailsFoodItemRecord.categoryRef,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                10.0, 0.0, 0.0, 0.0),
                            child: Text(
                              foodDetailsFoodItemRecord.description,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Inter',
