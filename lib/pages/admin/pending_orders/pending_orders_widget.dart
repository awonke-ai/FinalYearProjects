...
import '/pages/admin/adminorder_details/adminorder_details_widget.dart';
import '/pages/empty/order_empty/order_empty_widget.dart';
import 'package:flutter/material.dart';
import 'pending_orders_model.dart';
export 'pending_orders_model.dart';
...
class _PendingOrdersWidgetState extends State<PendingOrdersWidget> {
  late PendingOrdersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PendingOrdersModel());
            ...
            StreamBuilder<List<OrdersRecord>>(
              stream: queryOrdersRecord(
                queryBuilder: (ordersRecord) =>
                    ordersRecord.orderBy('placedAt', descending: true),
              ),
                    ...
                    return Padding(
                      ...
                      child: StreamBuilder<FoodItemRecord>(
                        stream: FoodItemRecord.getDocument(
                            listViewOrdersRecord.itemsOrdered.first),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
