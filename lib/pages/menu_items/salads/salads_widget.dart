...
import 'salads_model.dart';
export 'salads_model.dart';

class SaladsWidget extends StatefulWidget {
  const SaladsWidget({super.key});

  @override
  State<SaladsWidget> createState() => _SaladsWidgetState();
}

class _SaladsWidgetState extends State<SaladsWidget> {
  late SaladsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SaladsModel());
