...
import 'krispy_deals_model.dart';
export 'krispy_deals_model.dart';

class KrispyDealsWidget extends StatefulWidget {
  const KrispyDealsWidget({super.key});

  @override
  State<KrispyDealsWidget> createState() => _KrispyDealsWidgetState();
}

class _KrispyDealsWidgetState extends State<KrispyDealsWidget> {
  late KrispyDealsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KrispyDealsModel());
              ...
              Padding(
                ...
                child: StreamBuilder<List<FoodItemRecord>>(
                  stream: queryFoodItemRecord(
                    queryBuilder: (foodItemRecord) => foodItemRecord.where(
                      'categoryRef',
                      isEqualTo: 'Krispy Deals',
                    ),
                  ),
