...
import 'krispy_combos_model.dart';
export 'krispy_combos_model.dart';

class KrispyCombosWidget extends StatefulWidget {
  const KrispyCombosWidget({super.key});

  @override
  State<KrispyCombosWidget> createState() => _KrispyCombosWidgetState();
}

class _KrispyCombosWidgetState extends State<KrispyCombosWidget> {
  late KrispyCombosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KrispyCombosModel());
