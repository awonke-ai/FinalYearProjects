...
import 'crunchy_meals_model.dart';
export 'crunchy_meals_model.dart';

class CrunchyMealsWidget extends StatefulWidget {
  const CrunchyMealsWidget({super.key});

  @override
  State<CrunchyMealsWidget> createState() => _CrunchyMealsWidgetState();
}

class _CrunchyMealsWidgetState extends State<CrunchyMealsWidget> {
  late CrunchyMealsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrunchyMealsModel());
