                                ...
                                children: [
                                  ...
                                  StreamBuilder<List<PaymentsRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<PaymentsRecord>
                                          textPaymentsRecordList =
                                          snapshot.data!;
                                      // Return an empty Container when the item does not exist.
                                      if (snapshot.data!.isEmpty) {
                                        return Container();
                                      }
                                      final textPaymentsRecord =
                                          textPaymentsRecordList.isNotEmpty
                                              ? textPaymentsRecordList.first
                                              : null;

                                      return Text(
                                        valueOrDefault<String>(
                                          textPaymentsRecord?.referenceID,
                                          '000',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    dateTimeFormat(
                                      "yMMMd",
                                      containerOrdersRecord.placedAt!,
