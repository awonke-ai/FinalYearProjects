...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'CustomizeOrder',
          path: '/customizeOrder',
          builder: (context, params) => CustomizeOrderWidget(
            foodRer: params.getParam(
              'foodRer',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['foodItem'],
            ),
          ),
        ),
        FFRoute(
          name: 'KrispyDeals',
          path: '/krispyDeals',
          builder: (context, params) => const KrispyDealsWidget(),
        ),
        FFRoute(
          name: 'User_Profile',
          path: '/userProfile',
        ...
        FFRoute(
          name: 'KrispyCombos',
          path: '/krispyCombos',
          builder: (context, params) => const KrispyCombosWidget(),
        ),
        FFRoute(
          name: 'Salads',
          path: '/salads',
          builder: (context, params) => const SaladsWidget(),
        ),
        FFRoute(
          name: 'CrunchyMeals',
          path: '/crunchyMeals',
          builder: (context, params) => const CrunchyMealsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'Add_New_Item',
          path: '/addNewItem',
          builder: (context, params) => const AddNewItemWidget(),
        ),
        FFRoute(
          name: 'My_Food_List',
          path: '/myFoodList',
        ...
        FFRoute(
          name: 'Food_DetailsCopy',
          path: '/Notifications',
          builder: (context, params) => const FoodDetailsCopyWidget(),
        ),
        FFRoute(
          name: 'Menu',
          path: '/menu',
        ...
        FFRoute(
          name: 'MyFavorites',
          path: '/myFavorites',
          builder: (context, params) => const MyFavoritesWidget(),
        ),
        FFRoute(
          name: 'getLocation',
          path: '/getLocation',
          builder: (context, params) => const GetLocationWidget(),
        ),
        FFRoute(
          name: 'MenuCategory',
          path: '/menuCategory',
          builder: (context, params) => const MenuCategoryWidget(),
        ),
        FFRoute(
          name: 'KrispyChicken',
          path: '/krispyChicken',
          builder: (context, params) => const KrispyChickenWidget(),
        ),
        FFRoute(
          name: 'paymentSuccess',
          path: '/paymentSuccess',
        ...
        FFRoute(
          name: 'ContacUs',
          path: '/contacUs',
          builder: (context, params) => const ContacUsWidget(),
        ),
        FFRoute(
          name: 'AboutUs',
          path: '/aboutUs',
